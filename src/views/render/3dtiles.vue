...
const render3dtiles = (viewer) => {
  ...
  //参考：http://cesium.xin/cesium/cn/Documentation1.62/Cesium3DTileset.html?classFilter=Cesium3DTileset
  let tilesetJson = {
    url,
    modelMatrix: m,
  ...
  // const tileset = viewer.scene.primitives.add(new Cesium.Cesium3DTileset(tilesetJson));
